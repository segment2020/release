...
<?$ElementID = $APPLICATION->IncludeComponent(
	...
	Array(
		...
		"VIEWSCOUNT" => showviews($resID['ID']),
	),
	$component
);?>
<p>
	<a href="<?=$arResult["FOLDER"].$arResult["URL_TEMPLATES"]["news"]?>" class='btn btn-blue'><?=GetMessage("T_NEWS_DETAIL_BACK")?></a>
</p>
...
<?$APPLICATION->IncludeFile('/tpl/widgets/content/promotions.php', array('company_id'=> $resID['PROPERTY_COMPANYID_VALUE']), array());?>
<?$APPLICATION->IncludeFile('/tpl/widgets/content/video.php', array('company_id'=> $resID['PROPERTY_COMPANYID_VALUE']), array());?>
<?$APPLICATION->IncludeFile('/tpl/widgets/content/hits.php', array('company_id'=> $resID['PROPERTY_COMPANYID_VALUE']), array());?>		

...
<div class="block-default in block-shadow content-margin detailblock">
	...
	<div class="infotvc">
		<span class="infotime">
			<? echo $arResult["DATE_CREATE"]; ?></span>
		<span class="infoview"><i class="icon-icons_main-05"></i>
			<? echo $arParams['VIEWSCOUNT']; ?></span>
...
?>
	<noindex>
		<div class="sourceblock">
			...
			<div class="link">
				<a href="<? echo $arResult['PROPERTIES']['imgSource']['VALUE']; ?>">
					<? echo $arResult['PROPERTIES']['imgSource']['VALUE']; ?>
				</a>
			</div>
		</div>
	</noindex>
...
?>
	...
	<div class="tagblock">
		...
		<?
				/*
				<a href="<?= $arResult['IBLOCK']['SECTION_PAGE_URL'] ?>?companyfilter_ff%5BTAGS%5D=
		<? echo $tag; ?>&set_filter=Фильтр&set_filter=Y">
		<? echo $tag; ?></a>
		*/
		?>
		<a href="/search/tagSearch.php?tags=<? echo trim($tag); ?>">#
			<? echo trim($tag); ?></a>
		<?			} ?>
	</div>
	<?	} ?>

...
<div class="col-sm-9 col-xs-12 content-margin" id="article">
	...
	<h1>
		<? echo $APPLICATION->sDocTitle;?>
	</h1>

	<div class='row'>
		<div class="col-xs-12 content-margin">
			<a href="/personal/mymaterials/edit/?iBlockId=<?= IBLOCK_ID_ALL_MATERIALS ?>&iBlockType=Materials">
...
foreach($arResult["IBLOCKS"] as $arIBlock) {  
	...
	if ($arIBlock["ID"] == IBLOCK_ID_NEWS_INDUSTRY || 
		...
		$csstag = "newstag";	
	if ($arIBlock["ID"] == IBLOCK_ID_ALL_MATERIALS)  
		$csstag = "notactive";
	...
	<div class="block-default in block-shadow content-margin corpnewsblock">
		<div class="newsbitem clearfix">
			<div class="secstatusblock <?= $sorted_arItem["statusblock"] ?>">
				<div class="secstatusblock_title">
					<? echo $sorted_arItem["status"]; ?>
				</div>
				<div class="secstatusblock_descr">
					<? echo $sorted_arItem["statusdescr"]; ?>
				</div>
			</div>
			<? if ($rejMessage) { ?>
		...
		<div class='textAlignRight'>
			...
			<? }
				...
				?>
			<a href="/personal/mymaterials/edit/?elementId=<? echo $sorted_arItem['ID']; ?>" class="btn btn-blue-full minbr">
				Редактировать
			</a>
		</div>

...
<head>
   ...
   <meta property="og:type" content="website"/> 
    ...
    <link rel="stylesheet" href="/tpl/css/editor/editor-styles.css" type="text/css" />
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-12 pad-sm-0">
                            <div class="flex-wrap">
                                ...
                                <a class="logo" href="/"></a>
                                <div class="btn-mobile-nav visible-xs" >
                                    <a href="/personal/" class="container-flex">
                                        <svg class="icon icon-lk_user">
                                            <use xlink:href="#icon-lk_user"></use>
                                        </svg> 
                                    </a>
                                </div>

                                    ...
                                    return (
                                        this.settings.forEach(function (n) {
                                            ...
                                            r.addEventListener("click", function () {
                                                ...
                                                e.api.tooltip.onHover(r, n.title, { placement: "top", hidingDelay: 500 }),
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    var t = "ordered" === e ? this.CSS.wrapperOrdered : this.CSS.wrapperUnordered,
                                        n = "ordered" === e ? "ol" : "ul";
                                    return this._make(n, [this.CSS.baseBlock, this.CSS.wrapper, t], { contentEditable: !this.readOnly });
                                },
                            },
                            {
                                key: "toggleTune",
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    if (!(t.length < 2)) {
                                        var n = t[t.length - 1],
                                            r = this.currentItem;
                                        r !== n || n.textContent.trim().length || (r.parentElement.removeChild(r), this.api.blocks.insert(void 0, void 0, void 0, void 0, !0), e.preventDefault(), e.stopPropagation());
                                    }
                                },
                            },
                            {
        ...
        function (e, t, n) {
            ...
            function c(e, t) {
                for (var n = {}, r = [], i = 0; i < e.length; i++) {
                    ...
                    -1 !== d ? (o[d].references++, o[d].updater(f)) : o.push({ identifier: u, updater: v(f, t), references: 1 }), r.push(u);
                }
                return r;
            }
            function l(e) {
                        ...
                        return this.map(function (t) {
                            var n = (function (e, t) {
                                ...
                                if (t && "function" == typeof btoa) {
                                    var i = ((o = r), (s = btoa(unescape(encodeURIComponent(JSON.stringify(o))))), (c = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(s)), "/*# ".concat(c, " */")),
